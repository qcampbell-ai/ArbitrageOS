...
docs/Company_Bible.md — mission, values, operating principles
docs/Product_Requirements.md — what we're building and why
docs/Architecture.md — how the systems fit together
docs/Roadmap.md — the phased plan and milestones
decisions/ — every architectural decision, in ADR format
sops/ — Standard Operating Procedures for day-to-day execution, starting with SOP-001-Candidate-Discovery.md
...
canonical copy.
SystemRoleContainsGitHub (this repo)Official source of truthPRD, Company Bible, Architecture, Roadmap, ADRs, SOPs, AI agent prompts, codeGoogle SheetsOperational system of recordLive business data: Dashboard, KPIs, Products, Inventory, Retailers, Purchases, Sales, Suppliers, Expenses, Daily Log, Scoreboard, Decision FrameworkGoogle DriveTemporary workspaceReceipts, PDFs, supplier catalogs, tax docs, brainstorms — nothing here is ever "official"
...
The Team
RoleWhoResponsibilitiesFounderYouVision, decisions, execution, capitalAtlasChatGPTStrategy, product direction, architecture, sprint planning, QAForgeClaudeDocumentation, markdown/spreadsheet artifacts, automation builds, code
Company Identity
...
docs/Roadmap.md for what happens next.
